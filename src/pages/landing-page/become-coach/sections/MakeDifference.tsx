...
function MakeDifference() {
  return (
    <Container className='py-12 flex flex-col gap-2 px-[300px]'>
      ...
      <div className="flex justify-center gap-10 text-white mt-8">
        <div className="p-8 bg-primary w-fit flex flex-col gap-2 rounded-lg">
          <img src={MentorEmpowerImage} />
          <h3 className="text-2xl font-semibold mt-2">Mentor &<br /> Empower Others</h3>
        ...
        <div className="p-8 bg-[#0A2E4A] w-fit flex flex-col gap-2 rounded-lg">
