  ...
  return (
    <>
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-grey-text">Enter the OTP  sent to your phone number</p>
      </div>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        <OTPInput
          ...
          renderInput={(props) => <input {...props} className="border border-primary/30 px-5 py-2 rounded-lg" />}
        />
